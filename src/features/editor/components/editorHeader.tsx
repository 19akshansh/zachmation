...
export const EditorSaveButton = ({ workflowId }: {
  workflowId: string,
}) => {
  return (
...
export const EditorNameInput = ({ workflowId }: {
  workflowId: string
}) => {
...
export const EditorBreadcrumbs = ({ workflowId }: {
  workflowId: string,
}) => {
  return (
    <Breadcrumb>
...
export const EditorHeader = ({
  ...
  return (
    <header className="flex h-14 shrink-0 items-center gap-2 border-b px-4 bg-background">
      <SidebarTrigger />
      <div className="flex flex-row items-center justify-between gap-x-4 w-ful">
